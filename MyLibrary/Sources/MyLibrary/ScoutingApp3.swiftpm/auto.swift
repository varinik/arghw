...
var text : String = "NNNNNNN"
var textm: String = "NNNNNNN"
var textb : String = "NNNNNNN"
var textc : String = "N"
    ...
    struct ImageOverlayMiddle: View {
        ...
        var body: some View {
            Menu {
                Button(action: {
                    ...
                    val = "square.fill"
                    print(val)
                    textc = data().changecharger(val: "F")
                ...
                Button(action: {
                    ...
                    textc = data().changecharger(val: "HF")
                    print(val)
                }, label: {
                ...
                Button(action: {
                    ...
                    val = "square"
                    print(val)
                    textc = data().changecharger(val: "N")
                }, label: {
    ...
    struct ImageOverlayBottom: View {
        //ne var for each one,t est
        @State var val :String = "circle.dotted"
        @State var val1 :String = "circle.dotted"
        @State var val2 :String = "circle.dotted"
...
struct maket1: View
{
    ...
    var body: some View
    {
        Button("Done"){flip = true; t = "Top: " + text1 + "\nMiddle: " + textm1 + "\nBottom: " + textb1; print(t)}
            .opacity(flip ? 0 : 1)
            .position(x:100, y:400)
            .font(.system(size: 40, weight: .bold)).foregroundColor(.red)
        if(flip == true){NavigationLink(destination: tele(name: $num, autos: $t)){Text("Next Page").position(x:0, y:400).font(.system(size: 40, weight: .bold)).foregroundColor(.red)}}
    }
}
    ...
    var body: some View {
        ...
        HStack(alignment: .top, spacing: nil){
            Image("image-1").resizable().scaledToFit()
                ...
                .overlay(ImageOverlayTop(), alignment: .bottomTrailing)
                .overlay(ImageOverlayMiddle(), alignment: .bottomTrailing)
                .overlay(ImageOverlayBottom(), alignment: .bottomTrailing)
            ...
            Image("charging").resizable().scaledToFit().fixedSize()
                ...
                .overlay(chargerOverlay(), alignment: .bottomTrailing)
